...
playerKeyMapping =
    Array.fromList
        ...
        , { left = Keyboard.Character "Z"
          , right = Keyboard.Character "X"
          , fire = Keyboard.Character "V"
          , goFaster = Keyboard.Character "B"
          , blast = Keyboard.Character "N"
          }
...
playersInit : Int -> { a | height : Float, width : Float } -> List Player
playersInit quantity { width, height } =
    List.take quantity
        [ playerInit
